...
const sttaddr = "0x45c164033df86847e16257e295c2fefef5e35b87";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x45c164033df86847e16257e295c2fefef5e35b87";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://nftgame.network/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0x45c164033df86847e16257e295c2fefef5e35b87',
                    'symbol': 'NFTG',
                    'decimals': '6',
                    'image': 'https://nftgame.network/images/logo.png',
                },
            },
